...
const ChatApp = () => {
  ...
  return (
    <div className="h-screen w-full flex bg-[#111b21] text-white overflow-hidden">
      {/* Sidebar */}
      <ChatSidebar
      ...
      <div className="flex-1 flex flex-col bg-[#0b141a] relative">
        {/* subtle whatsapp top bar shadow */}
        <div className="absolute top-0 left-0 right-0 h-16 bg-[#202c33] z-0" />
        ...
        <div className="relative flex flex-col h-full">
          ...
          <div className="flex-1 overflow-hidden px-6 py-4">
            <div className="h-full bg-[#0b141a] rounded-lg">
              <ChatMessages
                selectedUser={selectedUser}
                messages={messages}
                loggedInUser={loggedInUser}
          ...
          {/* Input */}
          <div className="px-6 pb-4 pt-2 bg-[#202c33]">
